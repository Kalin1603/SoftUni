namespace P02_StudentsServices
{
    ...
    public class StudentsService
    {
        ...
        public StudentsService(ApplicationDbContext dbContext, AddressesService addressesService)
        {
        ...
        public string GetAllStudents()
        {
            ...
            {
                sb.AppendLine($"{ student.Id,3} | { student.FirstName,10} | { student.LastName,10}");
            }
            sb.AppendLine(new string('-', 30));
